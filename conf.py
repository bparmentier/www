...
# BASE_URL = "www.brunoparmentier.be/"
...
DEPLOY_COMMANDS = ["rsync -rav --delete output/ bp@ramnode:~/www/"]
...
# alt="Creative Commons License" style="border-width:0" src="https://i.creativecommons.org/l/by/4.0/80x15.png" /></a>
# """
...
"""
#CONTENT_FOOTER = 'Contents &copy; {date} <a href="mailto:{email}">{author}</a> &ndash; Powered by <a href="http://getnikola.com" rel="nofollow">Nikola</a> &ndash; {license}'
...
<script type="text/javascript">
  ...
  (function() {
    var u=(("https:" == document.location.protocol) ? "https" : "http") + "://piwik.brunoparmentier.be/";
...
<noscript><p><img src="http://piwik.brunoparmentier.be/piwik.php?idsite=1" style="border:0;" alt="" /></p></noscript>
"""
